                        ...
                        <div className="flex-1 flex flex-col justify-center items-center px-4 md:px-8 lg:px-12 text-center">
                            <div className="max-w-md md:max-w-lg lg:max-w-xl space-y-6 md:space-y-8">
                                ...
                                <div className="pt-8 flex-col md:pt-12" >
                                    ...
                                    {/* 
                                    <button onClick={handleBooking} className="w-4/5   max-w-sm mx-auto relative inline-flex h-12 overflow-hidden rounded-2xl p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
