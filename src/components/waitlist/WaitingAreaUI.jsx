...
export default function WaitingAreaUI({
  waitingNumber,
  userData,
  waitingTime,
  waitingMessage,
  ...
  const handleDeviceOrientation = useCallback(
    (event) => {
      ...
      animationHandlers.updateCardTransform(
        ...
        card.clientHeight / 2 +
          (beta - ANIMATION_CONFIG.DEVICE_BETA_OFFSET) * 3,
        card,
        wrap
      );
    },
  ...
  return (
    <motion.div
      ...
      className="relative min-h-screen flex flex-col items-center justify-center px-4 py-12 overflow-y-auto"
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(0,0,0,0.95) 0%, rgba(20,20,30,0.9) 50%, rgba(0,0,0,0.95) 100%)",
              backdropFilter: "blur(20px)",
            }}
          />
                  ...
                  <div className="flex justify-center items-center space-x-4">
                    ...
                    <div className="text-center">
                      <motion.div
                        ...
                        transition={{
                          duration: 1,
                          repeat: remainingSeconds <= 60 ? Infinity : 0,
                        }}
                      >
                    ...
                    <div
                      className={`text-2xl sm:text-3xl font-bold ${getTimeColor()}`}
                    >
                      :
                    </div>
